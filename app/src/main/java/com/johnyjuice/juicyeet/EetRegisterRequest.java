...
public class EetRegisterRequest {
    ...
    protected String generateSoapRequestInternal(Date dat_odesl_force, PrvniZaslani prvni_zaslani_force, String uuid_zpravy_force, Overeni overeni_force){
        try {
            ...
            String sha1sum=loadTemplateFromResource("/assets/templates/sha1sum.txt");
            ...
            String templateBody=loadTemplateFromResource("/assets/templates/template_body.txt",hashes.get("template_body"));
            String templateSignature=loadTemplateFromResource("/assets/templates/template_signature.txt",hashes.get("template_signature"));
            String templateRequest=loadTemplateFromResource("/assets/templates/template_request.txt",hashes.get("template_request"));
    ...
    public EetSaleDTO getSaleDTO(){
        ...
        dto.pocet_zbozi= RegisterSale.getPocetzbozi();
        dto.zbozi = RegisterSale.getZbozi();
        dto.mnozstvi = RegisterSale.getMnozstvi();
        dto.cena_zbozi = RegisterSale.getCenaZbozi();
        return dto;
    }
