package com.johnyjuice.juicyeet.velocity;

import android.app.Application;
import android.content.res.AssetManager;
import android.util.Log;

import com.johnyjuice.juicyeet.SaleService;
...
public class TemplateManager {
    ...
    public TemplateManager(AssetManager manager, String templatesLocation){
        ...
        engine.setProperty("asset.resource.loader.class", "com.johnyjuice.juicyeet.velocity.AndroidAssetLoader");
        engine.setProperty("asset.resource.loader.path", templatesLocation);
        engine.setProperty("asset.resource.loader.manager", manager);

        engine.setProperty(VelocityEngine.RUNTIME_LOG_LOGSYSTEM_CLASS, "com.johnyjuice.juicyeet.velocity.Logger");
        engine.init();
