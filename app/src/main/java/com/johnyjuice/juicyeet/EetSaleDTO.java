...
/**
 * Created by Johny on 26.01.2017.
 */
...
public class EetSaleDTO implements Serializable{
    ...
    public String[] zbozi = new String[50];
    public String[] mnozstvi = new String[50];
    public Double[] cena_zbozi = new Double[50];
    public String pocet_zbozi;
